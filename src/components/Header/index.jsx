        ...
        <nav className="navbar navbar-expand-lg">
            <div className="container-fluid">
                <xpto>
                    ...
                    Nivela <span className="yello">Tech</span>
                </xpto>
                ...
                <div className="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
                    <ul className="navbar-nav  mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a id="white" className="nav-link active" aria-current="page" href="index.html">HOME</a>
                        </li>
                        <li className="nav-item">
                            <a id="white" className="nav-link" href="quemsomos.html">QUEM SOMOS</a>
                        </li>
                        <li className="nav-item">
                            <a id="white" className="nav-link" href="#">CONTATO</a>
                        </li>
                        <li className="nav-item">
